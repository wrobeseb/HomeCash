package pl.com.soap.homecash.config;
...
@EnableDynamoDBRepositories(basePackages = "pl.com.soap.homecash.repo", dynamoDBOperationsRef = "dynamoDBOperations")
@Configuration
public class HomeCashDynamoDBConfig {
